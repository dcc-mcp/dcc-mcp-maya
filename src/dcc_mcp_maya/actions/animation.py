...
_ACTIONS = [
    ...
    ('list_animation_curves', 'List animation curve nodes connected to an object', 'animation', ['animation', 'curves', 'list', 'query']),
    ('set_animation_curve_tangent', 'Set in/out tangent type on keyframes of an animation curve', 'animation', ['animation', 'tangent', 'keyframe']),
    ('bake_constraints', 'Bake constrained object animation to keyframes and remove constraints', 'animation', ['bake', 'constraints', 'keyframe']),
