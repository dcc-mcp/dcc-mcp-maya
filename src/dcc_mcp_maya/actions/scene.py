...
_ACTIONS = [
    ...
    ('group_objects', 'Group objects under a new group node', 'scene', ['group', 'hierarchy', 'scene']),
    ('parent_object', 'Set or clear the parent of an object', 'scene', ['parent', 'hierarchy', 'scene']),
    ('select_by_type', 'Select all objects of a given Maya type', 'scene', ['select', 'type', 'query']),
    ('duplicate_object', 'Duplicate an object with optional rename', 'scene', ['duplicate', 'copy', 'scene']),
    ('freeze_transforms', 'Freeze (bake) transforms on an object', 'scene', ['transform', 'freeze', 'scene']),
    ('center_pivot', 'Center the pivot point to the bounding box', 'scene', ['pivot', 'center', 'scene']),
    ('get_bounding_box', 'Get world-space bounding box of an object', 'scene', ['bbox', 'query', 'scene']),
    ('set_visibility', 'Show or hide an object', 'scene', ['visibility', 'show', 'hide', 'scene']),
    ('lock_object', 'Lock or unlock transform attributes', 'scene', ['lock', 'transform', 'scene']),
    ('get_scene_info', 'Get DAG hierarchy info for all transforms', 'scene', ['scene', 'info', 'hierarchy']),
    ('export_scene', 'Export the entire scene to a file', 'scene', ['export', 'scene', 'io']),
    ('set_frame_rate', 'Set the scene playback frame rate', 'scene', ['fps', 'framerate', 'scene']),
    ('list_cameras', 'List all cameras with attributes', 'scene', ['camera', 'list', 'query']),
    ('create_locator', 'Create a locator helper node', 'scene', ['locator', 'helper', 'create']),
]
