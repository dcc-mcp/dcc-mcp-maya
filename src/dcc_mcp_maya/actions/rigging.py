...
_ACTIONS = [
    ('create_joint', 'Create a Maya joint node for skeletal rigs', 'rigging', ['joint', 'skeleton', 'rigging']),
    ('create_curve', 'Create a NURBS curve from control points', 'rigging', ['curve', 'nurbs', 'rigging']),
    ...
    ('set_ik_fk_blend', 'Set the IK/FK blend weight on an IK handle', 'rigging', ['ik', 'fk', 'blend', 'rigging']),
    ('set_joint_limit', 'Set rotation limits on a joint axis', 'rigging', ['joint', 'limit', 'rotation', 'rigging']),
    ('get_blend_shape_targets', 'Query all targets on a blendShape deformer', 'rigging', ['blendshape', 'targets', 'query', 'rigging']),
    ('set_blend_shape_weight', 'Set the weight of a blend shape target', 'rigging', ['blendshape', 'weight', 'set', 'rigging']),
    ('set_joint_label', 'Set side and label type on a joint for mirror naming', 'rigging', ['joint', 'label', 'side', 'mirror', 'rigging']),
    ('list_deformers', 'List all deformers on a polygon mesh', 'rigging', ['deformer', 'list', 'query', 'rigging']),
    ('reorder_deformers', 'Reorder the deformer stack on a polygon mesh', 'rigging', ['deformer', 'order', 'stack', 'rigging']),
    ('attach_to_surface', 'Attach an object to a surface via follicle or geometry constraint', 'rigging', ['follicle', 'surface', 'attach', 'rigging']),
    ('create_follicle', 'Create a standalone follicle node on a mesh or NURBS surface', 'rigging', ['follicle', 'surface', 'uv', 'rigging']),
    ('get_closest_point_on_surface', 'Query the closest position, normal and UV on a surface', 'utility', ['closest', 'point', 'surface', 'query']),
    ('create_motion_path', 'Attach an object to a NURBS curve motion path', 'animation', ['motionpath', 'path', 'animate', 'curve']),
    ('get_skin_weights', 'Query per-vertex skin weights for a mesh skin cluster', 'rigging', ['skin', 'weights', 'query', 'rigging']),
    ('paint_skin_weights', 'Set skin weights for specified vertices on a joint', 'rigging', ['skin', 'weights', 'paint', 'rigging']),
    ('mirror_skin_weights', 'Mirror skin weights across a world axis plane', 'rigging', ['skin', 'weights', 'mirror', 'rigging']),
]
def create_joint(
