...
_ACTIONS = [
    ("create_set", "Create a Maya object set and optionally populate it", "utility", ["set", "collection", "group"]),
    ("add_to_set", "Add objects to an existing Maya object set", "utility", ["set", "add", "collection"]),
    ("remove_from_set", "Remove objects from a Maya object set", "utility", ["set", "remove", "collection"]),
    ("list_sets", "List all Maya object sets in the scene", "utility", ["set", "list", "query"]),
]
