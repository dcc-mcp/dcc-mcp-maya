...
_ACTIONS = [
    ('create_reference', 'Reference an external Maya file into the scene', 'scene', ['reference', 'file', 'io']),
    ('list_references', 'List all file references in the current scene', 'scene', ['reference', 'list', 'query']),
    ('remove_reference', 'Remove a file reference from the scene', 'scene', ['reference', 'remove', 'io']),
    ('reload_reference', 'Reload a previously unloaded file reference', 'scene', ['reference', 'reload', 'io']),
    ('unload_reference', 'Unload a file reference without removing it', 'scene', ['reference', 'unload', 'io']),
    ('list_namespaces', 'List all namespaces in the current scene', 'scene', ['namespace', 'list', 'query']),
]
