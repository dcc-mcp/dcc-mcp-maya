...
_ACTIONS = [
    ...
    ('get_mesh_normals', 'Query vertex normals for a polygon mesh', 'geometry', ['normals', 'vertex', 'query', 'mesh']),
    ('set_mesh_normal', 'Set a custom vertex normal on a polygon mesh', 'geometry', ['normals', 'vertex', 'set', 'mesh']),
    ('soften_normals', 'Soften or harden edge normals by angle threshold', 'geometry', ['normals', 'soft', 'hard', 'edge', 'mesh']),
]
