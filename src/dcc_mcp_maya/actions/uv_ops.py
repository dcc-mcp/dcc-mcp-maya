...
_ACTIONS = [
    ('get_uv_info', 'Query UV sets and coordinates on a polygon mesh', 'geometry', ['uv', 'query', 'uvset', 'mesh']),
    ('create_uv_set', 'Create a new UV set on a polygon mesh', 'geometry', ['uv', 'create', 'uvset', 'mesh']),
