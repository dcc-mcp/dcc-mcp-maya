...
_ACTIONS = [
    ...
    ('create_particle_system', 'Create a Maya particle or nParticle system', 'effects', ['particle', 'nparticle', 'effects', 'create']),
    ('get_particle_system_info', 'Query attributes of a Maya particle or nParticle system', 'effects', ['particle', 'nparticle', 'effects', 'query']),
    ('set_particle_attribute', 'Set an attribute on a Maya particle or nParticle shape node', 'effects', ['particle', 'nparticle', 'attribute', 'effects']),
    ('emit_particles', 'Emit particles into an existing Maya particle system', 'effects', ['particle', 'emit', 'effects']),
]
def create_nucleus(
