...
`dcc-mcp-maya` embeds an MCP Streamable HTTP server directly inside Autodesk Maya. Gemini (via an MCP-compatible client or custom integration) can discover and invoke 206 Maya tools over HTTP.
